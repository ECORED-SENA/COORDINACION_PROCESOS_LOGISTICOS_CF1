...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.align-items-center
      ...
      .col-lg-5.mx-auto
        img(src='@/assets/curso/tema4/f2.svg', alt='T4-F2').mb-5
    .col-lg-9.mb-5.mx-auto
      .bloque-texto-b.bloque-texto-cac.p-4
        .bloque-texto-b__texto
          i.fas.fa-quote-left.cab-color
          span.h2.mb-0 Es necesario recordar que todo se mide y que los indicadores son necesarios para poder mejorar: “Lo que no se mide no se puede controlar, y lo que no se controla no se puede gestionar”
          i.fas.fa-quote-right.cab-color
    hr.borde-cab
    ...
    AcordionA.mb-5(tipo="b" clase-tarjeta="tarjeta fondo-purpura-medio")
      ...
      div(titulo="Objetivos")
        ul.lista-ul--separador.mb-5
          ...
          li 
            i.fas.fa-angle-right.cab-color
            p Mejorar el uso de los recursos y activos asignados, para aumentar la productividad y efectividad en las diferentes actividades hacia el cliente final.
          li 
            i.fas.fa-angle-right.cab-color
      ...
      div(titulo="Utilidades")
        ul.lista-ul--separador.mb-5
          li 
            i.fas.fa-angle-right.cab-color
            p Parametrizador de la planeación de actividades logísticas.
          li 
            i.fas.fa-angle-right.cab-color
            p Medición de resultados.
          li 
            i.fas.fa-angle-right.cab-color
            p Proyección de logros.
          li 
            i.fas.fa-angle-right.cab-color
            p Identificación de mejoras internas.
          li 
            i.fas.fa-angle-right.cab-color
            p Dinamizador de los procesos logísticos de mercancías mediante la interrelación de todas sus actividades internas (armonía).
          li 
            i.fas.fa-angle-right.cab-color
            p Potencializador de la actividad comercial.
          li 
            i.fas.fa-angle-right.cab-color
            p Multiplicador de la realidad empresarial.
          li 
            i.fas.fa-angle-right.cab-color
            p Capacidad real.
          li 
    ...
    .tarjeta-avatar-b
      ...
      .tarjeta.transparent1
        .p-4
          .h4 MRP
          p.mb-0 (Material Resource Planning): brinda el soporte específico para propiciar una mayor productividad de las plantas y los principios del Kaizen.
    .tarjeta-avatar-b
      img(src='@/assets/curso/tema4/f13.svg', alt='T3-F13', style="width:60px; border-bottom:none;")
      .tarjeta.transparent1
        .p-4
    ...
    .tarjeta-avatar-b
      ...
      .tarjeta.transparent1
        .p-4
          .h4 TMS
          p.mb-0 (Transportation Management System o Sistema de Gestión del Transporte), es una solución que posibilita al usuario visualizar, racionalizar, simplificar y controlar diariamente toda la operación y el costo de transporte de una manera integrada.
    .tarjeta-avatar-b
      img(src='@/assets/curso/tema4/f13.svg', alt='T3-F13', style="width:60px; border-bottom:none;")
      .tarjeta.transparent1
        .p-4
          .h4 CRM
          p.mb-0 (Consumer Relationship Management o Administración de Relaciones con el Consumidor), estrategia que permite a las empresas identificar, atraer y retener a sus clientes. El CRM cubre los procesos de mercadeo, ventas y servicio al cliente.
    .tarjeta-avatar-b
      img(src='@/assets/curso/tema4/f13.svg', alt='T3-F13', style="width:60px; border-bottom:none;")
      .tarjeta.transparent1
        .p-4
    ...
    .tarjeta-avatar-b.mb-5
      img(src='@/assets/curso/tema4/f13.svg', alt='T3-F13', style="width:60px")
      .tarjeta.transparent2
        .p-4
          .h4 GPS
          p.mb-0 (Global Position System o Sistemas de Localizacion Satelital), localización mundial, por medio de tecnología satelital.
